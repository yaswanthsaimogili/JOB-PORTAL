...
Login Form</div>
  ...
  <li class="nav-item" >
    <a class="flex-sm-fill text-sm-center nav-link" id="emp" href="employerlogin.jsp" onclick="changeColor()">EmployerLogin</a>
  </li>
  </ul>
...
<div class="pass-link">
<a href="forgetpassword.jsp">Forgot password?</a></div>
