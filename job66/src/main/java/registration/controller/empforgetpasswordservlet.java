...
/**
 * Servlet implementation class empforgetpasswordservlet
 */
@WebServlet("/empforgetpasswordservlet")
public class empforgetpasswordservlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public empforgetpasswordservlet() {
        super();
	   ...
	   forgetpassworddao lgd= new forgetpassworddao();
	    try {
	    	...
	    	else
	    	{
	    		...
	    		RequestDispatcher rdi= request.getRequestDispatcher("empforgetpassword.jsp");
